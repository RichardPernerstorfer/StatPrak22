...
star_group_looking_3_fNIRS_mean <- function(data){
  imp_data <- add_all_groups(data, 3, 3)
  levels(imp_data$group_looking_3) <- list("a other" = "other", "content" = "content", "side" = "side")
  imp_data$group_looking_3 <- as.factor(imp_data$group_looking_3)
...
rm(fNIRS2, looking2, data.list, HbO_delayed_data, HbO_online_data, HbR_delayed_data, HbR_online_data, age_sex, fNIRSData, looking, imp_looking2, imp1, imp2, ndata, new_data)
